document.addEventListener('DOMContentLoaded', function() {
    ...
    const addServiceFormContainer = document.getElementById('add-service-form-container');
    ...
    if (showFormBtn && addServiceFormContainer && cancelFormBtn && addServiceForm) {
        console.log("Service management form elements found. Initializing form toggle logic.");
