document.addEventListener('DOMContentLoaded', function() {
    ...
    const addBranchFormContainer = document.getElementById('add-branch-form-container');
    ...
    if (showFormBtn && addBranchFormContainer && cancelFormBtn && addBranchForm) {
        console.log("Branch management form elements found. Initializing form toggle logic.");
