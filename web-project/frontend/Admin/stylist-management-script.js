document.addEventListener('DOMContentLoaded', function() {
    ...
    const addStylistFormContainer = document.getElementById('add-stylist-form-container');
    ...
    if (showFormBtn && addStylistFormContainer && cancelFormBtn && addStylistForm) {
        console.log("Stylist management form elements found. Initializing form toggle logic.");
        ...
        addStylistForm.addEventListener('submit', function(event) {
            ...
            const stylistSpecialty = document.getElementById('stylist-specialty').value;
